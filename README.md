...
The source repository is public. The npm package remains marked private to prevent accidental registry publication; GitHub source releases and npm publication are managed as separate channels.
